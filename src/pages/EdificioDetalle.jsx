...
import { ChevronLeft, MapPin, Clock, AlertTriangle, Share2, Copy, Check, ShieldAlert, Loader2, ThumbsUp, Info, Eye } from 'lucide-react';
...
export default function EdificioDetalle() {
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      await base44.entities.ActualizacionesSitios.create({ sitio_id: id, tipo_sitio: 'edificio', tipo_accion: updateForm.tipo, descripcion: updateForm.desc, nivel_dano_anterior: edificio.nivel_dano, nivel_dano_nuevo: updateForm.nivel || undefined, personas_atrapadas_anterior: edificio.personas_atrapadas, personas_atrapadas_nuevo: updateForm.atrapados || undefined, reportante_nombre: updateForm.nombre, reportante_contacto: updateForm.contacto, fuente: 'ciudadano' });
      const updateData = {};
