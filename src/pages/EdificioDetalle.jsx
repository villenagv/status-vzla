...
export default function EdificioDetalle() {
  ...
  const suscribirse = async () => {
    ...
    try {
      await base44.entities.SuscriptoresSeguimiento.create({ reporte_id: id, tipo_reporte: 'dano', telefono_whatsapp: subEmail.trim(), nombre_suscriptor: subNombre.trim(), activo: true });
      setSuscrito(true);
    } catch {}
          ...
          {suscrito ? (
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <input value={subEmail} onChange={e => setSubEmail(e.target.value)} placeholder={t('Tu email...', 'Your email...', 'Seu email...')} className="flex-1 border border-gray-200 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:border-blue-400" />
